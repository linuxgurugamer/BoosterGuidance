...
namespace BoosterGuidance
{
    ...
    public class BLController : Controller
    {
        ...
        public void LogSimulation()
        {
            ...
            Simulate.ToGround(tgtAlt, vessel, aeroModel, vessel.mainBody, tc, tgt_r, out targetT, Utils.LogType.simuate, logTransform, vessel.missionTime - logStartTime);
        ...
        public void StartLogging(string filename)
        {
            if (!Utils.LoggingActive)
            {
                ...
                Utils.Log(Utils.LogType.actual, "time phase x y z vx vy vz ax ay az att_err amin amax steer_gain target_error totalMass");
...

        {
            ...
            if (Utils.LoggingActive)
            {
                ...
                Utils.Log(Utils.LogType.actual, String.Format("{0:F1} {1} {2:F1} {3:F1} {4:F1} {5:F1} {6:F1} {7:F1} {8:F1} {9:F1} {10:F1} {11:F1} {12:F1} {13:F1} {14:F3} {15:F1} {16:F2}",
            ...
            if ((lastPhase != phase) && (Utils.LoggingActive))
                LogSimulation();
