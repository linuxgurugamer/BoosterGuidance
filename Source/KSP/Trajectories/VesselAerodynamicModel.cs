...
namespace Trajectories
{
    ...
    public abstract class VesselAerodynamicModel
    {
        ...
        public bool UseCache { get { return true; } }
        ...
        {
            Log.Info("Trajectories: Initializing cache");
        ...
        public Vector3d GetForces(CelestialBody body, Vector3d bodySpacePosition, Vector3d airVelocity, double angleOfAttack)
        {
            ...
            //Log.Info("[Trajectories] GetForces useCache=" + UseCache);
            if (!UseCache)
        ...
        public Vector3d ComputeForces(double altitude, Vector3d airVelocity, Vector3d vup, double angleOfAttack)
        {
            ...
            //Log.Info("[Trajectories] ComputeForces");
            ...
            {
                Log.Info(string.Format("Trajectories: WARNING: {0} totalForce is NAN (altitude={1}, airVelocity={2}, angleOfAttack={3}", AerodynamicModelName, altitude, airVelocity.magnitude, angleOfAttack));
            ...
            {
                Log.Info("Trajectories: res is NaN (altitude=" + altitude + ", airVelocity=" + airVelocity.magnitude + ", angleOfAttack=" + angleOfAttack);
